...
**Part 2** (`inlist_wd_o_ne_3_phase`) loads `wd1_10_mi8_3_ONeNa.mod`, a $1.1 M_{\odot}$ ONeNa white dwarf with a helium atmosphere, and evolves it until the core temperature drops below $2 \times 10^6\ \mathrm{K}$.
